...
const COLLECTIONS: CollectionSpec[] = [
  ...
  { field: "btcUsdCandles", fields: "id open high low close sum count timestamp", outFile: "btcUsdCandles-hour.json", interval: "hour" },
  { field: "btcUsdCandles", fields: "id open high low close sum count timestamp", outFile: "btcUsdCandles-day.json", interval: "day" },
  { field: "hashpriceBtcs", fields: "id price timestamp", outFile: "hashpriceBtcs.json" },
  { field: "hashpriceBtcCandles", fields: "id open high low close sum count timestamp", outFile: "hashpriceBtcCandles-hour.json", interval: "hour" },
  { field: "hashpriceBtcCandles", fields: "id open high low close sum count timestamp", outFile: "hashpriceBtcCandles-day.json", interval: "day" },
  { field: "hashpriceUsds", fields: "id price timestamp", outFile: "hashpriceUsds.json" },
  { field: "hashpriceUsdCandles", fields: "id open high low close sum count timestamp", outFile: "hashpriceUsdCandles-hour.json", interval: "hour" },
  { field: "hashpriceUsdCandles", fields: "id open high low close sum count timestamp", outFile: "hashpriceUsdCandles-day.json", interval: "day" },
];
