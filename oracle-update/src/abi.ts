...
export const hashrateOracleAbi = [
  {
    ...
    inputs: [
      ...
      { name: "_tokenDecimals", internalType: "uint8", type: "uint8" },
    ],
    stateMutability: "nonpayable",
  },
  {
  ...
  {
    type: "function",
    inputs: [{ name: "newHashesForBTC", internalType: "uint256", type: "uint256" }],
  ...
  },
  {
    type: "function",
    inputs: [
      { name: "newBtcPriceTTL", internalType: "uint256", type: "uint256" },
      { name: "newHashesForBTCTTL", internalType: "uint256", type: "uint256" },
    ],
    name: "setTTL",
    outputs: [],
    stateMutability: "nonpayable",
